...
/* harmony default export */ exports["default"] = {
  ...
  methods: {
    ...
    playSound: function(){
      var startgif=document.getElementById("sounds"+this.index);
      var audiosource=document.getElementById("audio"+this.index);
      if(audiosource.getElementsByTagName("SOURCE")[0].src) {
        startgif.src = '/static/sounds.gif'
        audiosource.play();
      }
    }
  }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }) : _vm._e()]), _vm._v(" "), _vm._t("phonetic", [_c('span', {
    staticClass: "phonetic",
    domProps: {
      "textContent": _vm._s(_vm.phonetic)
    }
  })]), _vm._v(" "), _vm._t("sounds", [_c('img', {
    class: _vm.sounds,
    attrs: {
      "src":'/static/sounds.png',
      "id": 'sounds' + _vm.index
    },
    on: {
      "click": _vm.playSound
